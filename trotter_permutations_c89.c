 ...
 * размер массива temp на строке 30*/
#include <stdio.h>
	...
	int main () {
				...
				/*Факториал. Остановка при fact 0
				 * Можно остановить алгоритм, проверяя установлен
				 * ли массив целых temp после поиска подвижных*/
				int fact=3628800;
